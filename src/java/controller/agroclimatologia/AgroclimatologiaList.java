...
@WebServlet(name = "AgroclimatologiaList", urlPatterns = {"/Agroclimatologia/List"})
public class AgroclimatologiaList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         String rta="";
         for (Agroclimatologia agroclimatologia: AgroclimatologiaFacade.listAll()) {
             rta="";
//             rta+="{
...
//	    \"Lote_idlote\":\"+agroclimatologia.getLote().getIdlote()+\"
//             },";
         }
