...
@WebServlet(name = "LecturaevotranspiracionList", urlPatterns = {"/Lecturaevotranspiracion/List"})
public class LecturaevotranspiracionList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String rta = "";
        for (Lecturaevotranspiracion lecturaevotranspiracion : LecturaevotranspiracionFacade.listAll()) {
//             rta+="{
...
//	    \"Metricaevotranspiracion_idmetricaEvotranspiracion\":\"+lecturaevotranspiracion.getMetricaevotranspiracion().getIdmetricaEvotranspiracion()+\"
//             },";
            rta = "";
        }
