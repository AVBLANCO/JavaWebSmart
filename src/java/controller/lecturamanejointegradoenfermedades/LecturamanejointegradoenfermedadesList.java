...
@WebServlet(name = "LecturamanejointegradoenfermedadesList", urlPatterns = {"/Lecturamanejointegradoenfermedades/List"})
public class LecturamanejointegradoenfermedadesList extends HttpServlet {
