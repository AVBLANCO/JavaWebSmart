...
@WebServlet(name = "ManejointegradoenfermedadesList", urlPatterns = {"/Manejointegradoenfermedades/List"})
public class ManejointegradoenfermedadesList extends HttpServlet {
