...
@WebServlet(name = "MetricaconversionenergeticaList", urlPatterns = {"/Metricaconversionenergetica/List"})
public class MetricaconversionenergeticaList extends HttpServlet {
