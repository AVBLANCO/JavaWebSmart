...
@WebServlet(name = "MetricamanejointegradoenfermedadesList", urlPatterns = {"/Metricamanejointegradoenfermedades/List"})
public class MetricamanejointegradoenfermedadesList extends HttpServlet {
